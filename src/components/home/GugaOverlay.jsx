    ...
    <AnimatePresence>
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: '0 0 80px rgba(255,43,43,0.08), inset 0 0 120px rgba(255,43,43,0.03)',
        }}
        ...
        <div className="flex-shrink-0 px-6 md:px-10 pt-5 pb-0">
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-4">
              <span className="font-mono text-xs tabular-nums"
                style={{ color: elapsed >= TOTAL ? '#00D6C9' : '#FF2B2B', textShadow: '0 0 12px currentColor' }}>
                {pad(elapsed)}s
              </span>
              <button
                onClick={onClose}
          ...
          <div className="h-[1.5px] w-full bg-white/5 rounded-full overflow-hidden">
            <motion.div
              ...
              style={{
                width: `${progress}%`,
                background: 'linear-gradient(90deg, #FF2B2B, #00D6C9)',
                boxShadow: '0 0 8px rgba(255,43,43,0.5)',
        ...
        <div className="flex-1 overflow-y-auto px-6 md:px-10 pt-8 pb-8 md:pb-10">
          ...
          <div className="mb-8 md:mb-10">
            <h2 className="font-display font-black text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-tight leading-[1.1] text-white">
              ...
              <span style={{ color: '#FF2B2B', textShadow: '0 0 30px rgba(255,43,43,0.3)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-8">
            ...
            <div className="relative rounded-lg overflow-hidden" style={{ aspectRatio: '4/3' }}>
              ...
              <div className="absolute bottom-4 left-4">
                ...
                <p className="font-mono text-xs mt-0.5" style={{ color: '#00D6C9' }}>Motion Designer</p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {STATS.map(({ value, label }) => (
                  <div
                    ...
                    style={{ background: 'rgba(255,43,43,0.05)', border: '1px solid rgba(255,43,43,0.12)' }}
                  >
              ...
              <div className="flex flex-wrap gap-2">
                {CHIPS.map((chip) => (
                  <span
                    ...
                    style={{ border: '1px solid rgba(255,43,43,0.25)', color: 'rgba(255,43,43,0.7)', background: 'rgba(255,43,43,0.05)' }}
                  >
                    {chip}
                  </span>
                ))}
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              ...
              style={{ background: 'linear-gradient(135deg, #FF2B2B, #B31217)', boxShadow: '0 0 24px rgba(255,43,43,0.25)' }}
            >
              Ver trabalhos
            </a>
            <a
